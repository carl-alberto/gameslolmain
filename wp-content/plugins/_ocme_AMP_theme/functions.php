...
amp_font('https://fonts.googleapis.com/css?family=Open+Sans:400,600');

function amp_sanitize_widget_text($text) {
	
	$sanitizer = new AMPFORWP_Content( $text, array(), 
	...
	$amp_text = $sanitizer->get_amp_content();
	return $amp_text;
	
}

add_filter('widget_text', 'amp_sanitize_widget_text');
